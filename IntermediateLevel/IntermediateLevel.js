...
function comenzar() {
    ...
    // Genera la multiplicación - Números aleatorios entre 10 y 99
    ...
    if (indiceOpCorrecta == 0) {
        ...
        op2.innerHTML = respuesta + 10;
        op3.innerHTML = respuesta - 10;
    }
    if (indiceOpCorrecta == 1) {
        op1.innerHTML = respuesta - 10;
        op2.innerHTML = respuesta;
        op3.innerHTML = respuesta + 20;
    }
    if (indiceOpCorrecta == 2) {
        op1.innerHTML = respuesta + 20;
        op2.innerHTML = respuesta - 20;
